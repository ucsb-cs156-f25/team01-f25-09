...
|---------------------------|--------------|-------------|
| UCSBDiningCommonsMenuItem |  Samprita    |  samc005    |
| UCSBOrganization          |  David       |davidbazan383|
| RecommendationRequest     |   Lauren     |  laurenc06  |
| MenuItemReview            |     Onur     |  oyararbas  |
| HelpRequest               |   Dennis     | dkim876     |
| Articles                  |  Viktor      |viktorinkov  |
